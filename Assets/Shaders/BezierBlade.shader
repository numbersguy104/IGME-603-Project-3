Shader "Custom/BezierBlade"
{
    Properties
    {
        ...
        _GrassAlbedo ("Grass gloss", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings i, bool isFrontFace : SV_IsFrontFace) : SV_Target
            {
                ...
                // float3 finalColor = mainLight.shadowAttenuation * mainLight.distanceAttenuation;
                float4 col;
                col = float4(finalColor, grassCol.a);
